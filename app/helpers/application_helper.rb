module ApplicationHelper
  ...
  def link_to_add_fields(name, f, association)
    # Takes an object (@competition) and creates a new instance of its associated model (:competition_divisions)
    # To better understand, run the following in your terminal:
    # rails c --sandbox
    # @competition = Competition.new
    # new_object = @competition.send(:competition_divisions).klass.new
    ...
    # record_name = :competition_divisions
    ...
    # `competition[competition_divisions_attributes][child_index_value][_destroy]`
